...
```
mdadm --create --name=RAID1_DEV --verbose --level=1 --raid-devices=2 /dev/md/md0 /dev/sdb1 /dev/sdc1
```
or

```
mdadm --create --name=RAID1_DEV --verbose --level=1 --raid-devices=2 /dev/md/md0 /dev/nvme1n1p1 /dev/nvme1n1p1
```
