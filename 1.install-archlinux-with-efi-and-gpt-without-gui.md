...
If your disk is nvme device then it can show /dev/nvme0 or /dev/nvme1 or /dev/nvme2 ...
...
### 4-B-1. Remove old RAID (If u want)
...
```
mdadm --create /dev/md/md0 --name=RAID1_DEV --verbose --level=1 --raid-devices=2 /dev/sdb1 /dev/sdc1
```
or

```
mdadm --create /dev/md/md0 --name=RAID1_DEV --verbose --level=1 --raid-devices=2 /dev/nvme1n1p1 /dev/nvme1n1p1
```
...
```
mkfs.xfs /dev/md/md0 -L "RAID_SYS"
```
