...
```
mdadm --create /dev/md0 --name=RAID1_DEV --verbose --level=1 --raid-devices=2 /dev/sdb1 /dev/sdc1
```
...
### 4-B-4. Create filesystem

```
mkfs.ext4 /dev/md0 -L "RAID_SYS"
```
