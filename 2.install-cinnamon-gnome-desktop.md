...
![vga_driver]([image/vga_driver.PNG](https://i.imgur.com/vKM8eXq.png))
...
```
sudo pacman -S xfce4 xfce4-goodies gvfs-mtp lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings
