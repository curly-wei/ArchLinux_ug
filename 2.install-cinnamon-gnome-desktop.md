...
```
sudo pacman -S xfce4 xfce4-goodies gvfs-mtp lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings gnome-keyring gnome-shell gdm
...
## gnome-keyring gnome-shell gdm: refer to here: https://gitlab.gnome.org/GNOME/gnome-keyring/-/issues/28 
```
